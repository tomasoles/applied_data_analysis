...
Hodnotenie predmetu pozostáva z dvoch zložiek, ktoré spolu určujú výslednú známku.

\smallskip
\noindent\textbf{Zložka 1 --- podmienka na získanie certifikátu CERGE-EI (60\,\% výslednej známky).}
Táto zložka sa riadi kritériami hodnotenia modulu \textit{Ekonometria v kocke} (Časť II). Na úspešné
absolvovanie musí študent dosiahnuť aspoň 50\,\% zo záverečnej skúšky a zároveň aspoň 50\,\% z hodnotenia
tejto zložky.

\begin{itemize}
  \item \textbf{Tri online kvízy --- 30\,\%}
  \item \textbf{Dve domáce zadania (prevažne v R) --- 20\,\%}
  \item \textbf{Otázky a diskusia na hodine --- 10\,\%}
  \item \textbf{Záverečná skúška --- 40\,\%.} Záverečná skúška pokrýva vlastnosti, odvodenie, predpoklady a
        interpretáciu lineárnej regresie, ako aj základné kauzálne výskumné dizajny a techniky panelových
        údajov.
\end{itemize}

\smallskip
\noindent\textbf{Zložka 2 --- na získanie plného počtu bodov z predmetu (40\,\% výslednej známky).}
Táto zložka pokrýva Časť I predmetu.

\begin{itemize}
  \item \textbf{Kvízy a zadania --- 50\,\%.} Počas semestra budú študenti dostávať kvízy alebo krátke
        zadania počas prednášok aj po nich. Aktívna účasť a nadštandardné zapojenie do týchto kvízov a
        zadaní môžu túto časť hodnotenia pozitívne ovplyvniť podľa uváženia vyučujúceho.
  \item \textbf{Záverečný dátový projekt --- 50\,\%.} Záverečná prezentácia dátového projektu.
\end{itemize}

\smallskip
\noindent\textbf{Výpočet výslednej známky:} Študenti nemusia dosiahnuť aspoň 50\,\% v každej jednotlivej
položke Časti I. Výsledná známka sa určí na základe kumulatívneho skóre zo všetkých zložiek, pri splnení
vyššie uvedenej podmienky absolvovania Zložky 1.
...
\begin{itemize}
  ...
  \item \textbf{Týždeň záverečných skúšok:} 7. -- 11. december 2026
  \item \textbf{Týždeň opravných skúšok:} 14. -- 18. december 2026
\end{itemize}
...
6 & \textbf{Klasifikácia.} Úvod do klasifikácie kvalitatívnych premenných. Klasifikátory: logistická
regresia, naivný Bayesov klasifikátor, metóda k-najbližších susedov, zovšeobecnené lineárne modely. Pojmy
klasifikácie: pretrénovanie, matica zámen, špecificita a senzitivita analýzy.
\readings{Literatúra: Gareth et al. (2013), kap.~4.}
& utorok 27. 10. 2026\newline Prednáška 13:30--15:00, 4B26\newline Cvičenie 15:00--16:30, 4B26\newline \textit{T. Oleš} \\
\midrule

7 & \textbf{Zhluková analýza.} Učenie bez učiteľa a pojem podobnosti. Metóda k-priemerov. Hierarchické
zhlukovanie a dendrogramy. Voľba počtu zhlukov. Analýza hlavných komponentov a jej využitie v zhlukovej
analýze. Aplikácie na ekonomické údaje.
\readings{Literatúra: Gareth et al. (2013), kap.~12.}
