...
The course evaluation is based on two components, which together determine the final grade.

\smallskip
\noindent\textbf{Component 1 --- condition for obtaining the CERGE-EI certificate (60\% of the final grade).}
This component follows the evaluation criteria of the \textit{Econometrics in a Nutshell} module (Part II).
To pass, a student needs to score 50\% and higher on the final exam and secure 50\% and higher of this
component's grade.

\begin{itemize}
  \item \textbf{Three online quizzes --- 30\%}
  \item \textbf{Two home assignments (mostly based on R) --- 20\%}
  \item \textbf{In-class questions and discussions --- 10\%}
  \item \textbf{Final exam --- 40\%.} The final exam covers the properties, derivation, assumptions and
        interpretation of linear regression, as well as basic causal research designs and panel data
        techniques.
\end{itemize}

\smallskip
\noindent\textbf{Component 2 --- to obtain the full number of points from the course (40\% of the final grade).}
This component covers Part I of the course.

\begin{itemize}
  \item \textbf{Quizzes and assignments --- 50\%.} Throughout the course, students will receive quizzes or
        short assignments during and after lectures. Active participation and extra involvement in these
        quizzes or assignments may also positively influence this portion of the grade at the instructor's
        discretion.
  \item \textbf{Final data science project --- 50\%.} The final presentation of a data science project.
\end{itemize}

\smallskip
\noindent\textbf{Final Grade Calculation:} Students do not need to achieve at least 50\% in each individual
component of Part I. The final grade will be based on the cumulative score across all components, subject to
the passing condition of Component 1 stated above.
...
\begin{itemize}
  ...
  \item \textbf{Final exam week:} December 7 -- 11, 2026
  \item \textbf{Make-up exam week:} December 14 -- 18, 2026
\end{itemize}
...
6 & \textbf{Classification.} Introduction to qualitative classification. Classifiers: logistic regression,
naive Bayes, K-nearest neighbors, generalized linear models. Classification concepts: overfitting, confusion
matrix, specificity and sensitivity of the analysis.
\readings{Reading: Gareth et al. (2013), Ch.~4.}
& Wed 28 Oct 2026\newline Lecture 11:00--12:30, 4B26\newline Exercise 13:30--15:00, D203\newline \textit{T. Oleš} \\
\midrule

7 & \textbf{Clustering.} Unsupervised learning and the notion of similarity. K-means clustering.
Hierarchical clustering and dendrograms. Choosing the number of clusters. Principal component analysis and
its use in cluster analysis. Applications to economic data.
\readings{Reading: Gareth et al. (2013), Ch.~12.}
& Wed 4 Nov 2026\newline Lecture 11:00--12:30, 4B26\newline Exercise 13:30--15:00, D203\newline \textit{M. Vaško} \\
\midrule
