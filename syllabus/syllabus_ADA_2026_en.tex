...
\begin{itemize}
  ...
  \item \textbf{Final data project: 35\%.} A project on a question and a dataset of the student's own
        choosing, presented at the end of the semester. It draws on both Part I and Part II and is the
        concluding piece of work for the course.
\end{itemize}
