...
author: " Tomáš Oleš, Eduard Nežinský, Ella Sargsyan"
...
- 1-6 introduction to data science, visualization, tiding, wrangling, probability (text mining) and classification **Tuesday (slovak classes) Thursday (english classes)**
- 7-12 introduction to econometrics, linear regression, introduction causal research design methods, panel data techniques  **Excercise Tuesday|Thursday. Lectures - Friday ** 
